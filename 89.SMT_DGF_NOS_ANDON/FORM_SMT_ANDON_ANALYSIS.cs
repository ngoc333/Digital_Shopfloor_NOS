...
namespace FORM
{
    public partial class FORM_SMT_ANDON_ANALYSIS : Form
    {
        public FORM_SMT_ANDON_ANALYSIS()
        {
            InitializeComponent();
        }
        #region Ora
       ...
       // int cMachine = 0, cQual = 0, cProd = 0, cCount = 0;
        bool flag = false;
        //public FORM_SMT_ANDON_ANALYSIS(string Title, int _indexScreen, string _Line, string _Mline)
        //{
        //    InitializeComponent();
