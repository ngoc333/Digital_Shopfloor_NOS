...
namespace FORM
{
    public partial class FORM_SMT_ANDON_ANALYSIS_MONTH : Form
    {
        public FORM_SMT_ANDON_ANALYSIS_MONTH()
        {
            InitializeComponent();
        }
        #region Ora
      ...
      //  int indexScreen;
        ...
        private void tmrDate_Tick(object sender, EventArgs e)
        {
            ...
            if (cCount >= 30)
            {
                try
                {
                    dtB = SEL_DATA_ANDON("B", sLine, sMline, null);
                    ...
                    dtA = SEL_DATA_ANDON("A", sLine, sMline, null);
                    ...
                    dtC = SEL_DATA_ANDON("C", sLine, sMline, "LA");
                    BindingChart(chartSumQual, dtC, "HH", "DT");
                    dtC = SEL_DATA_ANDON("C", sLine, sMline, "LB");
                    BindingChart(chartSumMa, dtC, "HH", "DT");
                    dtC = SEL_DATA_ANDON("C", sLine, sMline, "LC");
        ...
        private void initForm()
        {
            ...
            switch (ComVar.Var._strValue3)
            {
                case "Vn":
                    ...
                    btnWeek.Text = "Tuần";
                    btnYear.Text = "Năm";
                    lblTitle.Text = "Phân tích dữ liệu andon theo tháng";
                    break;
                case "En":
                    btnDay.Text = "Day";
                    btnMonth.Text = "Month";
                    btnWeek.Text = "Week";
                    btnYear.Text = "Year";
                    lblTitle.Text = "Andon Data Analysis by Month";
                    break;
            }
