...
namespace FORM
{
    public partial class FORM_LOB_CHART : Form
    {
       ...
       // init strinit = new init();
        ...
        private void loadData(string type, string ymd, string plant, string line, string mline)
        {
            try
            {
                ...
                if (dtChart.Rows.Count > 0)
                {
                    ...
                    chart.Series[0].ArgumentDataMember = "PROCESS_NAME_VN";
                    chart.Series[0].ValueDataMembers.AddRange(new string[] { "CYCLE_TIME" });
                    //chart.Series[1].ArgumentDataMember = "PROCESS_NAME_VN";
                    //chart.Series[1].ValueDataMembers.AddRange(new [] { "TAKTTIME" });
        ...
        {
            lblTitle.Text = "LOB CHART - Line 1";
