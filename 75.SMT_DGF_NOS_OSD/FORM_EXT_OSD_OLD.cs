...
namespace FORM
{
    public partial class FORM_EXT_OSD_OLD : Form
    {
        public FORM_EXT_OSD_OLD()
        {
            InitializeComponent();
            //tmrDate.Stop();
        }
       ...
       // init strinit = new init();
        ...
        public FORM_EXT_OSD_OLD(string Title, int _indexScreen, string _Line, string _Mline,string _Lang)
        {
            InitializeComponent();
        ...
        private void axfpOSD_ClickEvent(object sender, AxFPSpreadADO._DSpreadEvents_ClickEvent e)
        {
           ...
           //MessageBox.Show(date);
            this.TopMost = false;
            POPUP_EXT_OSD frm_pop = new POPUP_EXT_OSD(line, Mline, date, date);
            frm_pop.ShowDialog();
