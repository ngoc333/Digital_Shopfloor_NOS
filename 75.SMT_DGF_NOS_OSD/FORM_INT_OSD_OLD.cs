...
namespace FORM
{
    public partial class FORM_INT_OSD_OLD : Form
    {
        public FORM_INT_OSD_OLD()
        {
            InitializeComponent();
            timer1.Stop();
        }
        ...
        int cCount = 0;
        public FORM_INT_OSD_OLD(string Caption, int indexScreen, string Line_cd, string Mline_cd, string Lang)
        {
            InitializeComponent();
            timer1.Stop();
        ...
        private DataTable SEL_DATA_OSD(string ARG_TYPE,string ARG_FROM,string ARG_TO)
        {
            ...
            MyOraDB.Process_Name = "MES.SP_GMES0280_1";
            ...
            MyOraDB.Parameter_Name[12] = "CV_1";
        ...
        private void bindingDataGrid(string DATE_FROM, string DATE_TO)
        {
            ...
            DataTable dt =  dtf= SEL_DATA_OSD(Mline, DATE_FROM, DATE_TO);
        ...
        private void BindingChart()
        {
            try
            {
                ...
                DataTable dt = SEL_DATA_OSD(Mline + "C", DATE_FROM, DATE_FROM);
        ...
        private void initForm()
        {
            ...
            {
                this.lblTitle.Text = "Hàng hư xưởng trả về theo ngày";
            }
            else
            {
