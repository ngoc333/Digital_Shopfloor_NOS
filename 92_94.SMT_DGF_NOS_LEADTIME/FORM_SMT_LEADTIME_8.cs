...
namespace FORM
{
    public partial class FORM_SMT_LEADTIME_8 : Form
    {
        public FORM_SMT_LEADTIME_8()
        {
            InitializeComponent();
            //setToolTip(cmdL1_Val13);
        ...
        readonly string _strToolTipVal6 = "Upper Inventory";
        ...
        //private void setToolTip(Button arg_button)
        //{
        //    toolTip_Val13.SetToolTip(arg_button, _strToolTip);
        //    toolTip_Val13.OwnerDraw = true;
        //    toolTip_Val13.Draw += new DrawToolTipEventHandler(toolTip_Val13_Draw);
        //    toolTip_Val13.Popup += new PopupEventHandler(toolTip_Val13_Popup);
        //}
        ...
        private void load_Data()
        {
            try
            {
                ...
                {
                    if (dt.Rows[i]["CON_NM"].ToString()== "cmdL2_Val2")
                    { }
            ...
            try
            {
                DataTable dt = LOAD_DATA("").Select("RN = '4' or RN = '5'or RN = '6'", "SORT_ORDER, STYLE_CD, RN DESC").CopyToDataTable(); ;
                pnMain.Visible = true;
                if (dt == null || dt.Rows.Count == 0) return;
        ...
        private void load_data_grid(DataTable arg_dt)
        {
            try
            {
                ...
                if (arg_dt != null && arg_dt.Rows.Count > 0)
                {
                    ...
                    {
                        axGrid.set_ColWidth(i, Convert.ToDouble(arg_dt.Rows[0]["col_width"]) + 10);
                    }
        ...
        private void initForm()
        {
            ...
            if (_wh_cd == "003")
                ...
                cmdMline.Text = _wh_cd.Substring(2, 1);
            else
                cmdMline.Text = _mline_cd.Substring(2, 1);
            switch (Lang)
            {
                case "Vn":
                    btnDay.Text = "Ngày";
            ...
            if (_wh_cd != "001" && _wh_cd != "002" && _wh_cd != "003" && _wh_cd != "004" && _wh_cd != "005" && _wh_cd != "006")
                SetControlName("cmdL1", "cmdL" + cmdMline.Text);
            //ShowGp(gpL1);
            ShowPic(PicL1_1);
        ...
        private DataTable LOAD_DATA()
        {
            try
            {
                ...
                string process_name;
                //if (_wh_cd == "099")
                //    process_name = "MES.PKG_SMT_PROD_SHOW.SEL_LEAD_TIME_V2";
                //else
                process_name = "MES.PKG_SMT_PROD_SHOW.SEL_LEAD_TIME_V2";
                //ARGMODE
                MyOraDB.ReDim_Parameter(3);
        ...
        private DataTable LOAD_DATA(string arg_cmd)
        {
            try
            {
                ...
                string process_name;
                //if (_wh_cd == "099")
                    process_name = "MES.PKG_SMT_PROD_SHOW.SEL_LEAD_TIME_DETAIL_V2";
                //else
                //    process_name = "MES.PKG_SMT_PROD_SHOW.SEL_LEAD_TIME_DETAIL";
                //ARGMODE
        ...
        private void FRM_SMT_LEADTIME_VisibleChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SetControlName("cmdL" + cmdMline.Text, "cmdL1");
                HidePic();
            }
        }
        ...
        private void lblMline_Click(object sender, EventArgs e)
        {
            try
            {
