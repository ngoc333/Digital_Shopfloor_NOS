...
namespace FORM
{
    public partial class POPUP_SMT_LEADTIME_TARGET : Form
    {
        ...
        public POPUP_SMT_LEADTIME_TARGET()
        {
            InitializeComponent();
        }

        public POPUP_SMT_LEADTIME_TARGET(string ARG_LINE,string ARG_CON_GRP, string ARG_CON_CD)
        {
            InitializeComponent();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (dl == DialogResult.Yes)
            {
                ...
                else
                {
                    ...
                    if (UPDATE_STAND_VALUE("Q", txtMin.Text, txtMax.Text,_LINE_CD, _CON_GRP, _CON_CD))
                    {
