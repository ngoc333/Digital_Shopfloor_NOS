...
namespace FORM
{
    public partial class FORM_SMT_LEADTIME : Form
    {
        public FORM_SMT_LEADTIME()
        {
            ...
            setToolTip(toolTip_Val6, cmdL3_Val6, _strToolTipVal6);
            ...
            //cmdMline.DoubleClick +=new EventHandler(lblMline_DoubleClick);
        }
        ...
        private void Export_File_Text(DataTable dt)
        {
        ...
        private void cmd_Val13_MouseHover(object sender, EventArgs e)
        {
