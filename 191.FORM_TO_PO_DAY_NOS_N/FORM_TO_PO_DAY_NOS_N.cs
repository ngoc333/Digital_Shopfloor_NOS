...
namespace FORM
{
    public partial class FORM_TO_PO_DAY_NOS_N : Form
    {
        public FORM_TO_PO_DAY_NOS_N()
        {
            InitializeComponent();
            addUC();
        }
       ...
       // UC.UC_DWMY uc = new UC.UC_DWMY(3);
        ...
        private void addUC()
        {
            ...
            tbl_main.Controls.Add(UC_STOCK, 1, 0);
            tbl_main.Controls.Add(UC_ASSE, 1, 1);
