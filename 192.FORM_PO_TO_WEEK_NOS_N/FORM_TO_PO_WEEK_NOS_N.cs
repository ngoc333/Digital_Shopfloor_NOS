...
namespace FORM
{
    public partial class FORM_TO_PO_WEEK_NOS_N : Form
    {
        public FORM_TO_PO_WEEK_NOS_N()
        {
            InitializeComponent();
        }
      ...
      //  FORM_TO_PO_WEEK_CHART frm_chart = new FORM_TO_PO_WEEK_CHART();
        ...
        public DataSet SEL_TO_PO_WEEKLY()
        {
            ...
            try
            {
                ...
                if (ComVar.Var._strValue1 == "001" || ComVar.Var._strValue1 == "002"|| ComVar.Var._strValue1 == "003"
                    || ComVar.Var._strValue1 == "001" || ComVar.Var._strValue1 == "002"|| ComVar.Var._strValue1 == "003")
        ...
        private void BindingData()
        {
           ...
           // strCol = dtsource.Rows[0]["COL"].ToString();
            grdView.DataSource = dtsource.Rows.Count > 0 ? dtsource.Select("COL1_TO is not null", "ORD, ORD2").CopyToDataTable() : dtsource;
