...
namespace FORM.UC
{
    ...
    public partial class UC_MONTH_SELECTION : UserControl
    {
        ...
        private string sYearValue = DateTime.Now.Year.ToString();
        private string sMonthValue = DateTime.Now.Month.ToString("00");
        readonly private string[] _arrMonthValue = { "01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12" };
        readonly private string[] _arrMonthShortName = { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" };
        readonly private string[] _arrMonthLongName = { "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "Novvember", "December" };
