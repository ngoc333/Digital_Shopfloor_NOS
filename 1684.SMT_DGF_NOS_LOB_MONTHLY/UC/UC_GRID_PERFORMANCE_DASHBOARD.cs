    ...
    public partial class UC_GRID_PERFORMANCE_DASHBOARD : UserControl
    {
        ...
        public void BindingData(string _title,string line,string mline)
        {
           ...
           // string Smile = null, Normal = null, Sad = null;
            //DataTable dt = SP_SMT_PERFORMANCE("Q", line, mline);
            ...
            string Smile = Application.StartupPath + "\\smile\\ok.png";
            string Normal = Application.StartupPath + "\\smile\\Normal.png";
            string  Sad = Application.StartupPath + "\\smile\\Cry.png";
            ...
            try
            {
                ...
                DataTable dt = SP_SMT_PERFORMANCE(_title, line, mline);
                //switch (_title)
                //{
                //    case "PRODUCTION":
