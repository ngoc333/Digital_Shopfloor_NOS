    ...
    public partial class FORM_SMT_PRODUCTIVITY_WEEK : Form
    {
       ...
       public FORM_SMT_PRODUCTIVITY_WEEK(string Title, int _indexScreen, string wh_cd, string mline_cd,string _Lang)
        ...
        public System.Data.DataSet LOAD_DATA_v2()
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_PROD_SHOW.SEL_PRODUCTIVITY_WEEKLY_L";
        ...
        private void load_data()
        {
            ...
            switch (Lang)
            {
                case "Vn":
                    ...
                    CreateChartBar(Chart2, ds.Tables[3], "May " + (1 + (3 * (iMline - 1))).ToString());
                    CreateChartBar(Chart3, ds.Tables[5], "May " + (2 + (3 * (iMline - 1))).ToString());
                    CreateChartBar(Chart6, ds.Tables[7], "May " + (3 + (3 * (iMline - 1))).ToString());
                ...
                default:
                    ...
                    CreateChartBar(Chart2, ds.Tables[3], "Stitching " + (1 + (3 * (iMline - 1))).ToString());
                    CreateChartBar(Chart3, ds.Tables[5], "Stitching " + (2 + (3 * (iMline - 1))).ToString());
                    CreateChartBar(Chart6, ds.Tables[7], "Stitching " + (3 + (3 * (iMline - 1))).ToString());
