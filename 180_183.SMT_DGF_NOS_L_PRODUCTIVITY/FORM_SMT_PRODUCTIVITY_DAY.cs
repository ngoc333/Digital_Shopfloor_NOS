...
namespace FORM
{
    public partial class FORM_SMT_PRODUCTIVITY_DAY : Form
    {
        ...
        string sStitching3TitleEn = "Stitching 3(Start 07:30)";
        string sStitching1TitleVn = "May 1(Từ 07:30)";
        string sStitching2TitleVn = "May 2(Từ 07:30)";
        string sStitching3TitleVn = "May 3(Từ 07:30)";
        ...
        private void load_data()
        {
            ...
            switch (Lang)
            {
                case "Vn":
                    ...
                    CreateChartLine(Chart6, select_Data("UPS3", ds.Tables[0]), sStitching3TitleVn);
                    CreateChartLine(Chart4, select_Data("FSS", ds.Tables[0]), "Chuẩn bị(Từ 08:00)");
                ...
                default:
                    ...
                    CreateChartLine(Chart6, select_Data("UPS3", ds.Tables[0]), sStitching3TitleEn);
                    CreateChartLine(Chart4, select_Data("FSS", ds.Tables[0]), "Stockfit(Start 08:00)");
        ...
        public System.Data.DataSet LOAD_DATA_v2()
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_PROD_SHOW.SEL_PRODUCTIVITY_DAILY_L";
        ...
        private void initForm()
        {
            ...
            else if (this._mline_cd == "004")
            {
                ...
                sStitching3TitleEn = "Stitching 12(Start 07:30)";
                sStitching1TitleVn = "May 10(Từ 07:30)";
                sStitching1TitleVn = "May 11(Từ 07:30)";
                sStitching1TitleVn = "May 12(Từ 07:30)";
            }
        }
