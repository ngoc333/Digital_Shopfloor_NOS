...
namespace FORM
{
    public partial class FORM_MAIN_6_LINE : Form
    {
        public FORM_MAIN_6_LINE()
        {
            InitializeComponent();
            // this.Text = "Insole";
            Init_Form();
       ...
       // string Lang = "En", LangTemp = null;
        ...
        private readonly int lockTimerCounterN = 0;
        bool _IsMain = true;
        #endregion
        ...
        //private DataTable getDatatable (DataTable ArgDt)
        //{
        ...
        //    dr["Name"] = "Target";
        //    dr["Value"] = ArgDt.Rows[1]["Target"];
        //    dt.Rows.Add(dr);

        //    dr = dt.NewRow();
        //    dr["Name"] = "Actual";
        //    dr["Value"] = ArgDt.Rows[1]["Actual"];
        //    dt.Rows.Add(dr);
        ...
        private void Init_Form()
        {
          //  ComVar.Var._strValue1 = "099";
            ...
            //  lbl_Line.Text = "Nos N";
            DataTable dt = dtPUPLayout();
            DataTable dtModel = SEL_MODEL_NAME("Q", "FTY1", "");
            string strLineCd, strMLine, strLineName;
            if (ccountN == 0)
            {
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    {
                        strLineCd = dt.Rows[i]["LINE_CD"].ToString();
                        strMLine = dt.Rows[i]["LINE_CD1"].ToString();
                        strLineName = dt.Rows[i]["LINE_NM"].ToString();
                        DataTable dtOS = SEL_PROD_MDI(strLineCd, strMLine);
                        UC.UC_MENU_DSF_2 MENU_WS = new UC.UC_MENU_DSF_2(strLineName, strLineCd, strMLine);
        ...
        private DataTable dtPUPLayout()
        {
            ...
            dt.Rows.Add("001", "", "Lean 1", "0", "0");
            dt.Rows.Add("003", "", "Lean 2", "0", "1");
            dt.Rows.Add("002", "", "Lean 3", "0", "2");
          //  dt.Rows.Add("FTY01", "004", "Line 4", "0", "3");
            dt.Rows.Add("004", "", "Lean 4", "1", "0");
            dt.Rows.Add("005", "", "Lean 5", "1", "1");
            dt.Rows.Add("006", "", "Lean 6", "1", "2");
        ...
        //{
        //        // if (_dtXML.Rows[0][argMenu].ToString() != "")
        //        //        ComVar.Var.callForm = _dtXML.Rows[0][argMenu].ToString();                
        ...
        void MenuOnClick(string MenuName, string BtnName)
        {
            try
            {
                ...
                else if (BtnName == "cmdQP")
                {
                    ...
                    FRM_PERFORMANCE_DASHBOARD f = new FRM_PERFORMANCE_DASHBOARD(Caption, 1, ComVar.Var._strValue1, MenuName, ComVar.Var._strValue3);
                    f.Show();
                }
                else
                {
        ...
        //{
        //    //addTextGauge("2342 sdfsdf dsf", UC_MENU1.dgModel);
        //    //addTextGauge("2342 sdfsdf dsf", UC_MENU2.dgModel);
        //    //addTextGauge("2342 sdfsdf dsf", UC_MENU3.dgModel);
        //    //addTextGauge("2342 sdfsdf dsf", UC_MENU4.dgModel);
        //    //addTextGauge("2342 sdfsdf dsf", UC_MENU5.dgModel);
        //    //addTextGauge("2342 sdfsdf dsf", UC_MENU6.dgModel);
        //    _iStartText++;
        //}
