...
namespace FORM.UC
{
    public partial class UC_MENU_DSF_2 : UserControl
    {
        public UC_MENU_DSF_2(string Title, string line, string mline )
        {
            ...
            picLine.Name += _lineCD;
            lblLine.Name += _lineCD;
        }
        #region Variable
        private string _MenuName = "";
        readonly string _lineCD = "";
        readonly string _MlineCD = "";
        #endregion
        ...
        private void btnItem_Click(object sender, EventArgs e)
        {
            if (_MenuName != null)
            {
                if (OnMenuClick != null)
                {
                    ...
                    OnMenuClick(_MlineCD, ((DevExpress.XtraEditors.SimpleButton)sender).Tag.ToString());
                }
            }
        }
                ...
                if (dt.Rows[0][0] != null)
                {
                    ...
                    switch (this.Name)
                    {
                        case "UC_MENU_NOSN_001":
                            picLine.BackgroundImage = Image.FromFile(Application.StartupPath + @"\img\img_NOS_N_N1.png");
        ...
        */
        ...
        readonly string[] FullText = new string[]
        {
        ...
        static readonly char[] specChars = new char[] { '.', '\'', ',', '-', ')', '(' };
        ...
        {
            if (!Directory.Exists(@"C:\\PFC_Nos" + LineName.Substring(2,1)))
            {
                ...
                if (dl == DialogResult.Yes)
                    Directory.CreateDirectory(@"C:\\PFC_Nos" + LineName.Substring(2, 1));
            }
            ...
            OpenFileDialog theDialog = new OpenFileDialog
            {
                ...
                InitialDirectory = @"C:\PFC_Nos" + LineName.Substring(2, 1)
            };
        ...
        private void mnQua1_Click(object sender, EventArgs e)
        {
            ...
            if (_lineCD=="002")
                CreateAndOpenFolder("003");
            else if (_lineCD=="003")
                CreateAndOpenFolder("002");
            else
       ...
       // const int AW_HIDE = 0x00010000;
        ...
        public void Animation(string Qtype, Control Grid)
        {
            ...
            "PFC","NPI","Tỉ Lệ\nChất Lượng","Hàng Hư\nTrả Về","KQ.Sản Xuất","BTS","Năng Suất","Smart Adon","Lead Time","Tồn Kho","Vắng Mặt","Relief Man","Đa Kỹ Năng",
            "PFC","NPI","Tỉ Lệ\nChất Lượng","Hàng Hư\nTrả Về","KQ.Sản Xuất","BTS","Năng Suất","Smart Adon","Lead Time","Tồn Kho","Vắng Mặt","Relief Man","Đa Kỹ Năng",
            "PFC","NPI","Tỉ Lệ\nChất Lượng","Hàng Hư\nTrả Về","KQ.Sản Xuất","BTS","Năng Suất","Smart Adon","Lead Time","Tồn Kho","Vắng Mặt","Relief Man","Đa Kỹ Năng",
            "PFC","NPI","Tỉ Lệ\nChất Lượng","Hàng Hư\nTrả Về","KQ.Sản Xuất","BTS","Năng Suất","Smart Adon","Lead Time","Tồn Kho","Vắng Mặt","Relief Man","Đa Kỹ Năng",
            "PFC","NPI","Tỉ Lệ\nChất Lượng","Hàng Hư\nTrả Về","KQ.Sản Xuất","BTS","Năng Suất","Smart Adon","Lead Time","Tồn Kho","Vắng Mặt","Relief Man","Đa Kỹ Năng",
            ...
            "PFC","NPI","Quality Rate","External OS&&D","Prod. Result","BTS","Productivity","Smart Adon","Lead Time","Outgoing\nInventory","Absenteeism","Relief Man","Multi Skill",
            "PFC","NPI","Quality Rate","External OS&&D","Prod. Result","BTS","Productivity","Smart Adon","Lead Time","Outgoing\nInventory","Absenteeism","Relief Man","Multi Skill",
            "PFC","NPI","Quality Rate","External OS&&D","Prod. Result","BTS","Productivity","Smart Adon","Lead Time","Outgoing\nInventory","Absenteeism","Relief Man","Multi Skill",
            "PFC","NPI","Quality Rate","External OS&&D","Prod. Result","BTS","Productivity","Smart Adon","Lead Time","Outgoing\nInventory","Absenteeism","Relief Man","Multi Skill",
            "PFC","NPI","Quality Rate","External OS&&D","Prod. Result","BTS","Productivity","Smart Adon","Lead Time","Outgoing\nInventory","Absenteeism","Relief Man","Multi Skill",
            ...
            DevExpress.XtraEditors.SimpleButton[] btn = new DevExpress.XtraEditors.SimpleButton[] { 
                 cmdQua1,cmdQua2,cmdQua3,cmdQua4, cmdPro1,cmdPro3,cmdPro2, cmdEqu1, cmdInv1, cmdInv2, cmdHrm1,cmdHrm2, cmdHrm3                   
            };
