...
namespace FORM
{
    public partial class FRM_SMT_FEMS : Form
    {
        ...
        public FRM_SMT_FEMS(string title, int _indexScreen, string _line, string _mline)
        {
            InitializeComponent();
        ...
        public DataTable SEL_SMT_MON_FEMS(string ARG_QTYPE, string ARG_LINE, string ARG_MLINE, string ARG_DATE)
        {
        ...
        private void load_head()
        {
            try
            {
                DataTable dt = SEL_SMT_MON_FEMS("H", line, mline, UC_MONTH.GetValue());
                int i;
        ...
        private void load_data()
        {
            ...
            {
                load_head();
                DataTable dt = SEL_SMT_MON_FEMS("Q3", line, mline, UC_MONTH.GetValue() );
                if (dt != null && dt.Rows.Count > 0)
                {
        ...
        private void bindingchart()
        {
            try
            {
                DataTable dt = SEL_SMT_MON_FEMS("C2", line, mline, UC_MONTH.GetValue());
                if (dt != null && dt.Rows.Count > 0)
                {
