...
namespace FORM
{
    public partial class FORM_SMT_LEADTIME_8 : Form
    {
        ...
        int _reload_data = 0;
        string _strToolTip = "Bottom Inventory At Stockfit";
        ...
        private void load_Data()
        {
            try
            {
                ...
                {
                    if (dt.Rows[i]["CON_NM"].ToString().Substring(0, 5) == "cmdL2")
                    { }
        ...
        private void initForm()
        {
            ...
            SetControlName("cmdL1", "cmdL" + lblMline.Text);
            //ShowGp(gpL1);
            ShowPic(PicL1_1);
        ...
        private void FRM_SMT_LEADTIME_VisibleChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SetControlName("cmdL" + lblMline.Text, "cmdL1");
                HidePic();
            }
        }
        ...
        {
            e.ToolTipSize = TextRenderer.MeasureText(_strToolTip, new Font("Arial", 16.0f));
        }
    }
}
