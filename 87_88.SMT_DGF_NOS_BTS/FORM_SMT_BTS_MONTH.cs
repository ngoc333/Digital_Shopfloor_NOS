...
namespace FORM
{
    public partial class FORM_SMT_BTS_MONTH : Form
    {
        public FORM_SMT_BTS_MONTH()
        {
            InitializeComponent();
        }
        [DllImport("user32")]
       ...
       // init strinit = new init();
        public FORM_SMT_BTS_MONTH(string title, int _indexScreen, string _line, string _mline,string _Lang)
        {
            InitializeComponent();
        ...
        public DataTable SEL_SMT_BTS(string ARG_QTYPE, string ARG_LINE, string ARG_MLINE, string ARG_DATE)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_PROD.SP_SMT_BTS";
