...
namespace FORM
{
    public partial class FRM_SMT_FG_INVENTORY : Form
    {
        public FRM_SMT_FG_INVENTORY()
        {
            InitializeComponent();
        }
        int indexScreen;
       ...
       // bool _load = false;
        public FRM_SMT_FG_INVENTORY(string Title, int _indexScreen, string _Line, string _Mline,string _Lang)
        {
            InitializeComponent();
        ...
        public DataTable SEL_FG_INV_MONTHLY_CHART(string ARG_LINE_CD, string ARG_MLINE_CD)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_PHUOC.SP_SMT_FG_INV";
        ...
        public DataTable SEL_FG_INV_DAILY_INCOM_CHART(string ARG_LINE_CD, string ARG_MLINE_CD)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_PHUOC.SP_SMT_FG_INCOMING";
        ...
        public DataTable SEL_FG_DAYS_INV(string ARG_LINE_CD, string ARG_MLINE_CD)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_PHUOC.SP_SMT_FG_DAYS_INV";
        ...
        private DataTable SEL_DATA(string ARG_LINE)
        {
            try
            {
                ...
                if (ComVar.Var._strValue1 == "009")
                    ...
                    MyOraDB.Process_Name = "MES.PKG_SMART_F_WH.SEL_DELIVERY_TRACKING";
