...
namespace FORM
{
    public partial class FORM_INCOMING_STATUS : Form
    {
        //bool _load = true;
        DataTable _dt = null;
        int icount = 0;
        ...
        public FORM_INCOMING_STATUS()
        {
            ...
            {
                axSpear.SetText(2, 1, "LINE 5");
                axSpear.SetText(4, 1, "LINE 6");
                axSpear.SetText(6, 1, "LINE 7");
                axSpear.SetText(8, 1, "LINE 8");
            }
        ...
        private DataTable LOAD_HH()
        {
            ...
            try
            {
                string process_name = "SEPHIROTH.PKG_SMF.SEL_INCOMING_HH";
        ...
        public DataTable LOAD_DATA_v2()
        {
            ...
            try
            {
                ...
                MyOraDB.Parameter_Values[0] = ComVar.Var._Area == "NOS_L2." ? "018_2" : ComVar.Var._strValue1;
        ...
        private void setHH()
        {
            try
            {
                DataTable dt = LOAD_HH();
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    axSpear.SetText(1, 3 + i, dt.Rows[i]["TXT"].ToString());
                }
            }
            catch (Exception)
            {}
